...
{
    /// <summary> 
    /// Exception thrown by an <see cref="BitSharper.Threading.IExecutor"/> when a task cannot be
    ...
    {
        /// <summary> 
        /// Constructs a <see cref="BitSharper.Threading.Execution.RejectedExecutionException"/> with no detail message.
        /// </summary>
        ...
        /// <summary> 
        /// Constructs a <see cref="BitSharper.Threading.Execution.RejectedExecutionException"/> with the
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="BitSharper.Threading.Execution.RejectedExecutionException"/> class.
        /// </summary>
        /// <param name="info">
