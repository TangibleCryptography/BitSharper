...
using BitSharper.Threading.AtomicTypes;
using BitSharper.Threading.Collections.Generic;
using BitSharper.Threading.Future;

namespace BitSharper.Threading.Execution
{
    //TODO PHASED correct the link to BitSharper.Threading.Execution.IScheduledExecutorService
    /// <summary> 
    ...
    internal static class Executors //JDK_1_6
    {
        ...
        /// <see cref="BitSharper.Threading.IThreadFactory"/> to create new threads when needed. 
        /// </summary>
        /// <remarks>
        ...
        /// <summary> 
        /// Creates an <see cref="BitSharper.Threading.IExecutor"/> that uses a single worker thread operating
        ...
        /// given time. Unlike the otherwise equivalent <see cref="BitSharper.Threading.Execution.Executors.NewFixedThreadPool(int)"/>,
        /// the returned executor is guaranteed not to be reconfigurable to use additional threads.
        /// </remarks>
        /// <returns> the newly created single-threaded <see cref="BitSharper.Threading.IExecutor"/> </returns>
        ...
        /// <summary> 
        /// Creates an <see cref="BitSharper.Threading.IExecutor"/> that uses a single worker thread operating
        /// off an unbounded queue, and uses the provided <see cref="BitSharper.Threading.IThreadFactory"/> to
        /// create a new thread when needed. 
        /// </summary>
        /// <remarks>
        /// Unlike the otherwise equivalent <see cref="BitSharper.Threading.Execution.Executors.NewFixedThreadPool(int, IThreadFactory)"/>, the
        ...
        /// Calls to <see cref="BitSharper.Threading.IExecutor.Execute(IRunnable)"/> will reuse previously constructed
        ...
        /// may be created using <see cref="BitSharper.Threading.Execution.ThreadPoolExecutor"/> constructors.
        /// </remarks>
        /// <returns>the newly created thread pool</returns>
        ...
        /// Creates a thread pool that creates new threads as needed, but
        /// will reuse previously constructed threads when they are
        /// available, and uses the provided <see cref="BitSharper.Threading.IThreadFactory"/>  to create new threads when needed.
        /// </summary>
        /// <param name="threadFactory">the factory to use when creating new threads</param>
        /// <returns> the newly created thread pool</returns>
        ...
        /// <see cref="BitSharper.Threading.Execution.IExecutorService"/> 
        ...
        /// <returns> an <see cref="BitSharper.Threading.Execution.IExecutorService"/> instance</returns>
        ...
        /// </summary>
        /// <remarks>
        /// This factory creates all new threads used by an <see cref="BitSharper.Threading.IExecutor"/>.
