...
using BitSharper.Threading.Locks;
...
namespace BitSharper.Threading.Execution
{
    ...
    ///                 <description>A bounded queue helps prevent 
    ...
    internal class ThreadPoolExecutor : AbstractExecutorService, IRecommendParallelism //BACKPORT_3_1
    {
        #region Worker Class
        ...
        protected internal class Worker : ReentrantLock, IRunnable
        {
            ...
            /// </summary>
            protected internal readonly Thread Thread;
        ...
        /// billion) otherwise representable. But until the need
        ...
        public TimeSpan KeepAliveTime
        {
            ...
            get { return new TimeSpan(Interlocked.Read(ref _keepAliveTicks)); }
        }
        ...
        protected override void DoExecute(IRunnable command)
        {
            ...
            {
                var recheck = _controlState.Value;
        ...
        {
            return Remove(new Runnable(task));
        }
        ...
        private void ProcessWorkerExit(Worker w, bool completedAbruptly)
        {
            ...
            {
                var min = _allowCoreThreadToTimeOut ? 0 : _corePoolSize;
        ...
        /// task is discarded.
        /// </summary>
        internal class CallerRunsPolicy : IRejectedExecutionHandler
        {
            /// <summary>
        ...
        /// </summary>
        internal class AbortPolicy : IRejectedExecutionHandler
        {
            /// <summary> 
        ...
        /// </summary>
        internal class DiscardPolicy : IRejectedExecutionHandler
        {
            /// <summary> 
        ...
        /// </summary>
        internal class DiscardOldestPolicy : IRejectedExecutionHandler
        {
            /// <summary> 
