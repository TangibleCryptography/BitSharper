...
{
    /// <summary> 
    /// An <see cref="BitSharper.Threading.IExecutor"/> that provides methods to manage termination and
    /// methods that can produce a <see cref="IFuture{T}"/> for tracking progress of
    /// one or more asynchronous tasks.
    /// </summary>
    /// <remarks>
    /// An <see cref="BitSharper.Threading.Execution.IExecutorService"/> can be shut down, which will cause it
    ...
    /// <see cref="BitSharper.Threading.IExecutor.Execute(IRunnable)"/> by creating and returning a <see cref="IFuture{T}"/> that
    /// can be used to cancel execution and/or wait for completion.
    /// Methods <see cref="InvokeAny{T}(System.Collections.Generic.IEnumerable{BitSharper.Threading.ICallable{T}})"/> and <see cref="InvokeAll{T}(System.Collections.Generic.IEnumerable{BitSharper.Threading.ICallable{T}})"/>
    ...
    /// 
    /// <p/>
    /// The <see cref="BitSharper.Threading.Execution.Executors"/> class provides factory methods for the
    /// executor services provided in this package.
    /// </remarks>
    /// <author>Doug Lea</author>
    /// <author>Griffin Caprio (.NET)</author>
    /// <author>Kenneth Xu</author>
    internal interface IExecutorService : IExecutor, IDisposable //JDK_1_6
    {
        /// <summary> 
        ...
        /// representing that task. The Future's <see cref="BitSharper.Threading.Future.IFuture{T}.GetResult()"/> method will
