...
using System;
using BitSharper.Threading.Execution;

namespace BitSharper.Threading
{
    /// <summary> 
    /// An object that executes submitted <see cref="BitSharper.Threading.IRunnable"/> tasks
    /// or an <see cref="Action"/>.
    /// </summary>
    /// <remarks> 
    /// This interface provides a way of decoupling task submission from the
    /// mechanics of how each task will be run, including details of thread
    /// use, scheduling, etc. An <see cref="BitSharper.Threading.IExecutor"/> is normally used
    /// instead of explicitly creating threads.
    /// <p/>
    /// However, the <see cref="BitSharper.Threading.IExecutor"/> interface does not strictly
    ...
    /// </code>
    /// 
    /// Many <see cref="BitSharper.Threading.IExecutor"/> implementations impose some sort of
    /// limitation on how and when tasks are scheduled. 
    /// <p/>
    /// The <see cref="BitSharper.Threading.IExecutor"/> implementations provided in this package
    /// implement <see cref="BitSharper.Threading.Execution.IExecutorService"/>, which is a more extensive
    /// interface. The <see cref="BitSharper.Threading.Execution.ThreadPoolExecutor"/> class provides an
    /// extensible thread pool implementation. The <see cref="BitSharper.Threading.Execution.Executors"/> class
    /// provides convenient factory methods for these Executors.
    /// </remarks>
    /// <author>Doug Lea</author>
    /// <author>Federico Spinazzi (.Net)</author>
    /// <author>Kenneth Xu</author>
    internal interface IExecutor //JDK_1_6
    {
        /// <summary> 
