...
using BitSharper.Collections.Generic;
using BitSharper.Threading.Utility;
...
namespace BitSharper.Threading.Collections.Generic
{
    ...
    [Serializable]
    internal class LinkedBlockingQueue<T> : AbstractBlockingQueue<T>, ISerializable //BACKPORT_3_1
    {
        ...
        {
            get { return _capacity == int.MaxValue ? int.MaxValue : _capacity - _activeCount; }
        }
