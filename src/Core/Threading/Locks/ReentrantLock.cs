...
using BitSharper.Threading.Helpers;

namespace BitSharper.Threading.Locks
{
    /// <summary> 
    ...
    [Serializable]
    internal class ReentrantLock : IDisposable, ConditionVariable.IExclusiveLock
    {
        ...
        {
            get { return _sync.IsHeldByCurrentThread; }
        }
        ...
        /// <summary> Creates an instance of <see cref="BitSharper.Threading.Locks.ReentrantLock"/>.
        ...
        /// <summary> 
        ///    Creates an instance of <see cref="BitSharper.Threading.Locks.ReentrantLock"/> with the
        ...
        /// fair ordering policy, a call to <see cref="BitSharper.Threading.Locks.ReentrantLock.TryLock()"/> <b>will</b>
        /// immediately acquire the lock if it is available, whether or not
        /// other threads are currently waiting for the lock.
        /// This &quot;barging&quot; behavior can be useful in certain
        /// circumstances, even though it breaks fairness. If you want to honor
        /// the fairness setting for this lock, then use
        /// <see cref="BitSharper.Threading.Locks.ReentrantLock.TryLock(TimeSpan)"/>
        ...
        /// are waiting for the lock. This is in contrast to the <see cref="BitSharper.Threading.Locks.ReentrantLock.TryLock()"/> 
        /// method. If you want a timed <see cref="BitSharper.Threading.Locks.ReentrantLock.TryLock()"/> that does permit barging on
        ...
        /// <summary> 
        /// Returns a <see cref="BitSharper.Threading.Locks.ICondition"/> instance for use with this
        /// <see cref="BitSharper.Threading.Locks.ILock"/> instance.
        /// 
        /// <p/>
        /// The returned <see cref="BitSharper.Threading.Locks.ICondition"/> instance supports the same
        ...
        /// <see cref="BitSharper.Threading.Locks.ICondition.Await()"/> or <see cref="BitSharper.Threading.Locks.ICondition.Signal()"/>
        /// methods are called, then an <see cref="System.InvalidOperationException"/>  is thrown.</item>
        /// <item>When the condition <see cref="BitSharper.Threading.Locks.ICondition"/>await() waiting}
        ...
        {
            get { return _sync.HasQueuedThreads; }
        }
        ...
        public virtual ICollection<Thread> QueuedThreads
        {
            get { return _sync.QueuedThreads; }
        }
