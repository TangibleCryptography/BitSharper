...
namespace BitSharper.Threading.Future
{
    /// <summary>
    ...
    internal class FutureTask<T> : IRunnableFuture<T>, IContextCopyingTask //BACKPORT_3_1
    {
        ...
        /// <summary> 
        /// Causes this future to report an <see cref="BitSharper.Threading.Execution.ExecutionException"/> 
        /// with the given <see cref="System.Exception"/> as its cause, unless this <see cref="IFuture{T}"/> has
        /// already been set or has been cancelled.
        /// </summary>
        /// <remarks>
        /// This method is invoked internally by the <see cref="BitSharper.Threading.IRunnable"/> method
